    ...
    <div className="space-y-5">
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <StatCard icon={FiActivity} label="Active Markets" value={data.activeMarkets.toString()} color="text-accent-green" />
      ...
      <div className="card">
        ...
        <div className="space-y-3">
          ...
          {withdrawStage === "confirmed" && <p className="text-xs text-accent-green">Fees withdrawn!</p>}
        </div>
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-accent-green/10 border border-accent-green/20 text-accent-green text-sm font-medium hover:bg-accent-green/20 disabled:opacity-50 transition-colors"
            >
          ...
          {resolverStage === "confirmed" && <p className="text-xs text-accent-green">Done!</p>}
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="space-y-3">
          ...
          {feeRecipientStage === "confirmed" && <p className="text-xs text-accent-green">Fee recipient added!</p>}
        </div>
      </div>
    </div>
  );
